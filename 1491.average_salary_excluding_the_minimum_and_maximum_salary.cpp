...
class Solution {
   public:
    double average(std::vector<int>& salary) {
        ...
        return sum / (static_cast<int>(salary.size()) - 2);
    }
};

int main() {
    Solution sol;
    //    std::vector<int> salaries = {4000, 3000, 1000, 2000};
    std::vector<int> salaries = {1000, 2000, 3000};
    std::cout << sol.average(salaries);
    return 0;
}